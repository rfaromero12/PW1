	...
	public static void main(String [] args) {
		...
		if(loged == 1) {
			...
			do {
				...
				case 6:
					String datos;
					datos = CManager.verDatos(username.toLowerCase());
				...
				case 7:
					...
					newNick = read.next();
					keynick = CManager.verifyUser(newNick);
				
					if(keynick == 0 && !newNick.equals(username) ) {
						System.out.println("Este usuario no esta disponible");
					}
						
					}while(keynick == 0 && !newNick.equals(username));
