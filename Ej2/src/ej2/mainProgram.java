			...
			do {
				...
				case 2 :
					...
					if(RManager.getReviewsUser(usernameSession).equals("")) {
						...
						if(RManager.delete(deleteId, usernameSession) == true) {
				...
				case 4 :
					...
					System.out.println("Introduzca la valoración que desea otorgarle:");
		...
		//Menú de usuario administrador
			...
			do {
				...
				case 2 :
					...
					System.out.println(SManager.printSessions(deleteId));
					
					System.out.println("1. Cancelar espectáculo completo (todas las sesiones).");
